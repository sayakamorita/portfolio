...
$datas ->execute(array($_REQUEST['page_list']));
$data = $datas->fetch();
...
if(!empty($_POST)){
    ...
    /*すべてのエラーチェックが完了し、エラーがない状態であればedit_check.phpに遷移するようにする*/
    if(!empty($_POST)){
        if(empty($error)){
            ...
            $_SESSION['edit']['p_language'] = $p_language;
            $_SESSION['edit']['id'] = $data['id'];
...
if($_REQUEST['action'] == 'rewrite_edit'&& isset($_SESSION['edit'])){
    $_POST['name'] = $_SESSION['edit']['name'];
    $_POST['email'] = $_SESSION['edit']['email'];
    $_POST['age'] = $_SESSION['edit']['age'];
    $_POST['sex'] = $_SESSION['edit']['sex'];
    $_POST['p_language'] = $_SESSION['edit']['p_language'];
}
...
<div id="wrap">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <!--URLがaction=rewrite_editだった場合、valueには編集したあとの値を出力する(if文で場合分け)-->
            <p>ニックネーム：<input type="text" name="name" 
            <?php if($_REQUEST['action'] === 'rewrite_edit'):?>
            value="<?php print(htmlspecialchars($_SESSION['edit']['name'],ENT_QUOTES));?>">
            <?php else:?>
            value="<?php print(htmlspecialchars($data['name'],ENT_QUOTES));?>"
                ...
                <?php endif;?>
                <?php if($error['name'] === 'wrong'):?>
                <p class="error">*日本語で入力してください。</p>
                <?php endif;?>
            </p>   
            ...
            <!--edit_check画面で戻るボタンをおされているかつセッションeditが存在しなかったら、-->
                ...
                <?php if($_REQUEST['action'] === 'rewrite_edit'&& $_POST['sex'] === '男性'){
                    echo 'checked';
                }elseif($data['sex'] === '男性'){
                    echo 'checked';
                };?>>
                ...
                <?php if($_REQUEST['action'] === 'rewrite_edit' && $_POST['sex'] === '女性') {
                    echo 'checked';
                }elseif($data['sex'] === '女性'){
                    echo 'checked';
                };?>>
                ...
                <?php if($_REQUEST['action'] === 'rewrite_edit' && $_POST['sex'] === '選択しない'){
                    echo 'checked';
            ...
            <p>年齢：</p>
                ...
                <option value='' disabled style='display:none;'>選択してください</option>
                    <option value='10代' 
                    <?php if($_REQUEST['action'] === 'rewrite_edit' && $_POST['age'] === '10代'){
                    echo 'selected';
                }elseif($data['age'] === '10代'){
                    echo 'selected';
                };?>>
                    ...
                    10代</option>
                    <option value='20代' 
                    <?php if($_REQUEST['action'] === 'rewrite_edit' && $_POST['age'] === '20代'){
                    echo 'selected';
                }elseif($data['age'] === '20代'){
                    echo 'selected';
                };?>>
                    ...
                    <option value='30代' 
                    <?php if($_REQUEST['action'] === 'rewrite_edit' && $_POST['age'] === '30代'){
                    echo 'selected';
                }elseif($data['age'] === '30代'){
                    echo 'selected';
                };?>>
                    ...
                    <option value='40代' 
                    <?php if($_REQUEST['action'] === 'rewrite_edit' && $_POST['age'] === '40代'){
                    echo 'selected';
                }elseif($data['age'] === '40代'){
                    echo 'selected';
                };?>>
                    ...
                    <option value='50代' 
                    <?php if($_REQUEST['action'] === 'rewrite_edit' && $_POST['age'] === '50代'){
                    echo 'selected';
                }elseif($data['age'] === '50代'){
                    echo 'selected';
                };?>>
            ...
            <label>
                ...
                <?php if($_REQUEST['action'] == 'rewrite_edit'){
                        if(strpos($_SESSION['edit']['p_language'],'Java') !== false){
                            echo 'checked';
                        }
                    }?>>
            ...
            <label>
                <input type="checkbox" name="p_language[]" class="checkbox01-input" value="JavaScrpit" 
                <?php if(strpos($data['p_language'],'Java') !== false){
                            echo 'checked';
                    }?>
                <?php if($_REQUEST['action'] == 'rewrite_edit'){
                    if(strpos($_SESSION['edit']['p_language'],'JavaScript') !== false){
                        echo 'checked';
                    }
                }?>>
            ...
            <label>
                ...
                <?php if($_REQUEST['action'] == 'rewrite_edit'){
                        if(strpos($_SESSION['edit']['p_language'],'PHP') !== false){
                            echo 'checked';
                        }
                    }?>>
            ...
            <label>
                ...
                <?php if($_REQUEST['action'] == 'rewrite_edit'){
                        if(strpos($_SESSION['edit']['p_language'],'Ruby') !== false){
                            echo 'checked';
                        }
                    }?>>
            ...
            <label>
                ...
                <?php if($_REQUEST['action'] == 'rewrite_edit'){
                        if(strpos($_SESSION['edit']['p_language'],'Python') !== false){
                            echo 'checked';
                        }
                    }?>>
            ...
            <label>
                ...
                <?php if($_REQUEST['action'] == 'rewrite_edit'){
                        if(strpos($_SESSION['edit']['p_language'],'HTML/CSS') !== false){
                            echo 'checked';
                        }
                    }?>>
            ...
            <label>
                ...
                <?php if($_REQUEST['action'] == 'rewrite_edit'){
                        if(strpos($_SESSION['edit']['p_language'],'Laravel') !== false){
                            echo 'checked';
                        }
                    }?>>
            ...
            <label>
                ...
                <?php if($_REQUEST['action'] == 'rewrite_edit'){
                        if(strpos($_SESSION['edit']['p_language'],'Ruby on Rails') !== false){
                            echo 'checked';
                        }
                    }?>>
